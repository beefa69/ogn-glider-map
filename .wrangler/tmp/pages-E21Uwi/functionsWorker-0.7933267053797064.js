...
async function onRequestGet(context) {
  ...
  const ognUrl = `http://live.glidernet.org/lxml.php?a=${showOffline}&b=${latMax}&c=${latMin}&d=${lngMax}&e=${lngMin}`;
  try {
    ...
    return new Response(
      JSON.stringify({ gliders, fetchedAt: (/* @__PURE__ */ new Date()).toISOString(), count: gliders.length }),
...
__name(parseOgnXml, "parseOgnXml");

// ../.wrangler/tmp/pages-E21Uwi/functionsRoutes-0.7164676283034623.mjs
var routes = [
  {
    routePath: "/ogn-proxy",
    mountPath: "/",
...
// C:/Users/b_bra/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/b_bra/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
